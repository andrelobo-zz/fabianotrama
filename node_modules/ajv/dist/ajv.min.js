      ...
      23: [
        function(e, r, t) {
          ...
          r.exports = function(e, r) {
            ...
            for (P in o) {
              "__proto__" != P &&
                ((k = o[P]), ((p = Array.isArray(k) ? v : m)[P] = k));
            }
            t += "var " + u + " = errors;";
            var g = e.errorPath;
            for (var P in ((t += "var missing" + a + ";"), v))
              if ((p = v[P]).length) {
                if (
                  ((t +=
                    " if ( " + c + e.util.getProperty(P) + " !== undefined "),
                  y &&
                    (t +=
                    ...
                    for (var w = -1, b = E.length - 1; w < b; ) {
                      ($ = E[(w += 1)]),
                        ...
                        (t +=
                          ...
                          a +
                          " = " +
                          e.util.toQuotedString(e.opts.jsonPointers ? $ : O) +
                          ") ) ");
                    }
                  t += ")) {  ";
                  var S = "missing" + a,
            ...
            for (var P in m) {
              ...
              (e.opts.strictKeywords
                ...
                (t += ") { "),
                (h.schema = k),
                (h.schemaPath = i + e.util.getProperty(P)),
                (h.errSchemaPath = n + "/" + e.util.escapeFragment(P)),
                (t += "  " + e.validate(h) + " "),
                (h.baseId = A),
                (t += " }  "),
                l && ((t += " if (" + f + ") { "), (d += "}")));
                  ...
                  if (Z((S = I[(A += 1)]))) {
                    if (
                      ...
                      if ("object" == S.type && a.schema.properties) {
                        ...
                        if (C)
                          for (var L, N = -1, z = C.length - 1; N < z; ) {
                            if (void 0 !== (Q = u[(L = C[(N += 1)])]).default) {
                              var T = f + a.util.getProperty(L);
                              if (a.compositeRule) {
                                if (a.opts.strictDefaults) {
                                  y = "default is ignored for: " + T;
                        ...
                        if (q)
                          for (var Q, $ = -1, V = q.length - 1; $ < V; )
                            if (void 0 !== (Q = q[($ += 1)]).default) {
                              T = f + "[" + $ + "]";
                              if (a.compositeRule) {
                                if (a.opts.strictDefaults) {
                                  y = "default is ignored for: " + T;
                    ...
                    for (
                      ...
                      if ((R < a && ++s > A && L("overflow"), R == a)) {
                        for (var $ = s, j = 36; ; j += 36) {
                          ...
                          var O = $ - D,
                            I = 36 - D;
                          r.push(C(z(D + (O % I), 0))), ($ = k(O / I));
                        }
                        r.push(C(z($, 0))), (o = T(s, w, p == d)), (s = 0), ++p;
                      }
                    }
                  } catch (e) {
                    (S = !0), (_ = e);
