...
module.exports.VscAdd = function VscAdd(props) {
  return GenIcon({
    tag: "svg",
    attr: { viewBox: "0 0 16 16", fill: "currentColor" },
    child: [{ tag: "path", attr: { d: "M14 7v1H8v6H7V8H1V7h6V1h1v6h6z" } }]
  })(props);
};
...
module.exports.VscChromeMaximize = function VscChromeMaximize(props) {
  return GenIcon({
    tag: "svg",
    attr: { viewBox: "0 0 16 16", fill: "currentColor" },
    child: [{ tag: "path", attr: { d: "M3 3v10h10V3H3zm9 9H4V4h8v8z" } }]
  })(props);
};
        ...
        child: [
          {
            tag: "clipPath",
            attr: { id: "clip0" },
            child: [{ tag: "path", attr: { d: "M0 0h24v24H0V0z" } }]
          }
        ]
      }
    ]
...
module.exports.VscDebugBreakpointConditionalUnverified = function VscDebugBreakpointConditionalUnverified(
  props
) {
  return GenIcon({
    tag: "svg",
...
module.exports.VscDebugBreakpointConditional = function VscDebugBreakpointConditional(
  props
) {
  return GenIcon({
    tag: "svg",
...
module.exports.VscDebugBreakpointDataUnverified = function VscDebugBreakpointDataUnverified(
  props
) {
  return GenIcon({
    tag: "svg",
...
module.exports.VscDebugBreakpointFunctionUnverified = function VscDebugBreakpointFunctionUnverified(
  props
) {
  return GenIcon({
    tag: "svg",
...
module.exports.VscDebugBreakpointFunction = function VscDebugBreakpointFunction(
  props
) {
  return GenIcon({
    tag: "svg",
...
module.exports.VscDebugBreakpointLogUnverified = function VscDebugBreakpointLogUnverified(
  props
) {
  return GenIcon({
    tag: "svg",
...
module.exports.VscDebugBreakpointUnsupported = function VscDebugBreakpointUnsupported(
  props
) {
  return GenIcon({
    tag: "svg",
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M2.5 2H4v12H2.5V2zm3.5.18V14l9-5.938-9-5.881zm6.315 5.882L7.5 5v6.18l4.815-3.118z"
        }
      }
    ]
  })(props);
...
module.exports.VscDebugPause = function VscDebugPause(props) {
  return GenIcon({
    tag: "svg",
    attr: { viewBox: "0 0 16 16", fill: "currentColor" },
    child: [{ tag: "path", attr: { d: "M4.5 3H6v10H4.5V3zm7 0v10H10V3h1.5z" } }]
  })(props);
};
...
module.exports.VscDebugReverseContinue = function VscDebugReverseContinue(
  props
) {
  return GenIcon({
    tag: "svg",
...
module.exports.VscDebugStackframeActive = function VscDebugStackframeActive(
  props
) {
  return GenIcon({
    tag: "svg",
    ...
    child: [
      { tag: "path", attr: { d: "M10 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0z" } },
      {
        tag: "path",
        attr: {
          d:
...
module.exports.VscDebugStackframeDot = function VscDebugStackframeDot(props) {
  return GenIcon({
    tag: "svg",
    attr: { fill: "currentColor" },
    child: [{ tag: "path", attr: { d: "M10 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0z" } }]
  })(props);
};
...
module.exports.VscDebugStart = function VscDebugStart(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: "path",
        attr: { d: "M4 2v11.82l9-5.94L4 2zm1.5 2.82l4.81 3.06L5.5 11V4.82z" }
      }
    ]
  })(props);
};
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M1 10c0-3.9 3.1-7 7-7s7 3.1 7 7h-1c0-3.3-2.7-6-6-6s-6 2.7-6 6H1zm4 0c0-1.7 1.3-3 3-3s3 1.3 3 3-1.3 3-3 3-3-1.3-3-3zm1 0c0 1.1.9 2 2 2s2-.9 2-2-.9-2-2-2-2 .9-2 2z"
        }
      }
    ]
  })(props);
...
module.exports.VscFileSymlinkDirectory = function VscFileSymlinkDirectory(
  props
) {
  return GenIcon({
    tag: "svg",
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M4 1L3 2v12l1 1h9l1-1V5l-.293-.707-3-3L10 1H4zm0 13V2h5v4h4v8H4zm9-9l-3-3v3h3z"
        }
      }
    ]
  })(props);
        ...
        child: [
          {
            ...
            attr: {
              d:
                "M.5 14h12l.48-.37 2.63-7-.48-.63H13V3.5l-.5-.5H6.71l-.86-.85L5.5 2h-5l-.5.5v11l.5.5zM1 3h4.29l.86.85.35.15H12v2H8.5l-.35.15-.86.85H2.5l-.47.34-1 3.08L1 3zm11.13 10H1.19l1.67-5H7.5l.35-.15.86-.85h5.79l-2.37 6z"
            }
          }
        ]
      },
        ...
        child: [
          {
            tag: "clipPath",
            attr: { id: "clip0" },
            child: [{ tag: "path", attr: { d: "M0 0h16v16H0V0z" } }]
          }
        ]
      }
    ]
    ...
    child: [
      {
        ...
        attr: {
          d:
            "M10.979 5a3.42 3.42 0 0 0-2-1V0h-1v4a3.5 3.5 0 0 0-.18 6.89h.18v4h1v-4a3.08 3.08 0 0 0 .84-.23 3.42 3.42 0 0 0 1.57-1.29 3.46 3.46 0 0 0-.41-4.37zm-.7 4.24a2.51 2.51 0 0 1-3.159.31 2.5 2.5 0 0 1-.92-1.12 2.49 2.49 0 0 1 1.82-3.41 2.72 2.72 0 0 1 .49 0 2.5 2.5 0 0 1 2.54 2.5 2.51 2.51 0 0 1-.8 1.75l.03-.03z"
        }
      }
    ]
  })(props);
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M8.06 3.854L5.915 6l-.707-.707L6.5 4h-3a1.5 1.5 0 0 0 0 3H4v1h-.5a2.5 2.5 0 1 1 0-5h3L6 2.5l-.793-.793L5.914 1l2.147 2.146v.708zM5 6.5l.914.914L6 7.328V14h8V7h-4V3h-.94v-.268L8.329 2H11.2l.3.1 3.4 3.5.1.4v8.5l-.5.5h-9l-.5-.5v-8zM11 3v3h2.903L11 3z"
        }
      }
    ]
  })(props);
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M1.5 1h2v1H2v12h1.5v1h-2l-.5-.5v-13l.5-.5zM14 3v4h-4V6H8v1H5V4h3v1h2V3h4zM7 5H6v1h1V5zm6-1h-2v2h2V4zm-3 5h4v4h-4v-2H8v1H5V9h3v1h2V9zm-3 1H6v1h1v-1zm4 2h2v-2h-2v2z"
        }
      }
    ]
  })(props);
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M7.5 13a5.5 5.5 0 0 0 5.498-5.354l.953-.952a6.5 6.5 0 1 1-1.208-3.038l-.717.718A5.5 5.5 0 1 0 7.5 13zm6.197-7.467L15 4.23l-.71-.71-3.41 3.42L9.5 5.56l-.71.71L10.52 8h.71l1.65-1.65.817-.817zM7 7v2h1V4H7v3zm0 4v-1h1v1H7z"
        }
      }
    ]
  })(props);
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M2 7l3.28-1.35-.39-.93-2.32 1A5.48 5.48 0 0 1 13.21 7h1A6.48 6.48 0 0 0 1.73 5.07L.92 3.12 0 3.5l1.34 3.24L2 7zm5.24-3h1v5h-1V4zm0 6h1v1h-1v-1zm6.9-1.67l1.34 3.23-.92.44-.82-2a6.49 6.49 0 0 1-12.5-2h1v-.5a5.49 5.49 0 0 0 10.64 1.89l-2.25.93-.39-.92 3.25-1.35.65.28z"
        }
      }
    ]
  })(props);
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M3.889 3.095a6.5 6.5 0 1 1 7.222 10.81A6.5 6.5 0 0 1 3.89 3.095zm.555 9.978a5.5 5.5 0 1 0 6.111-9.145 5.5 5.5 0 0 0-6.11 9.145zM8 5H7v5h1V5zm0 6H7v1h1v-1z"
        }
      }
    ]
  })(props);
...
module.exports.VscListTree = function VscListTree(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: "path",
        attr: { d: "M14 3v1H2V3h12zm-1 3v1H6V6h7zm0 3v1H5V9h8zm0 3v1H5v-1h8z" }
      },
      { tag: "path", attr: { d: "M5 4h1v9H5z" } }
    ]
  })(props);
};
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M4 7H3V4H0V3h3V0h1v3h3v1H4v3zm6.5-5.9l3.4 3.5.1.4v8.5l-.5.5h-10l-.5-.5V8h1v5h9V6H9V2H5V1h5.2l.3.1zM10 2v3h2.9L10 2z"
        }
      }
    ]
  })(props);
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M7 3H4V0H3v3H0v1h3v3h1V4h3V3zM5.5 7H5V6h.3l.8-.9.4-.1H14V4H8V3h6.5l.5.5v10l-.5.5h-13l-.5-.5V5h1v8h12V6H6.7l-.8.9-.4.1z"
        }
      }
    ]
  })(props);
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M4 2v12.48l8.915-6.24L4 2zm7.18 6.24l-6.185 4.328V3.912l6.186 4.328z"
        }
      }
    ]
  })(props);
        ...
        child: [
          {
            ...
            attr: {
              ...
              clipRule: "evenodd",
              d:
                "M0 7.337V2.5L.5 2h5l.35.15.86.85h5.79l.5.5V6h2.13l.48.63-2.63 7-.48.37H8.743a5.48 5.48 0 0 0 .657-1h2.73l2.37-6H8.743a5.534 5.534 0 0 0-.72-.724l.127-.126L8.5 6H12V4H6.5l-.35-.15L5.29 3H1l.013 3.246A5.531 5.531 0 0 0 0 7.336z"
            }
          },
          {
            tag: "path",
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M10.915 8.24L2 14.48V2l8.915 6.24zm-7.92 4.328L9.181 8.24 2.995 3.912v8.656zM5.5 14.48v-1.229l7.18-5.01L5.5 3.228V2l8.915 6.24L5.5 14.48z"
        }
      }
    ]
  })(props);
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M2.86 1l2.07 2.08-.7.7L3 2.56V7H2V2.55L.79 3.78l-.71-.71L2.15 1h.71zM15 3v4h-4V6H9v1H6V4h3v1h2V3h4zM8 5H7v1h1V5zm6-1h-2v2h2V4zm-3 5h4v4h-4v-2H9v1H6V9h3v1h2V9zm-3 1H7v1h1v-1zm4 2h2v-2h-2v2zm-9 1.45V9H2v4.44L.78 12.22l-.71.7L2.15 15h.7l2.07-2.07-.7-.71L3 13.45z"
        }
      }
    ]
  })(props);
    ...
    child: [
      {
        ...
        attr: {
          ...
          clipRule: "evenodd",
          d:
            "M7 12.5l.5.5h7l.5-.5v-9l-.5-.5h-7l-.5.5v9zM9 5h4v6H9V5zM5 9V5h1V4H4.5l-.5.5v7l.5.5H6v-1H5V9zM2 8V6h1V5H1.5l-.5.5v5l.5.5H3v-1H2V8z"
        }
      }
    ]
  })(props);
