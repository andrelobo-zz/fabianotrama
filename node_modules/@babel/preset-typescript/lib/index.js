...
var _pluginTransformTypescript = _interopRequireDefault(
    ...
    return {
      overrides: allExtensions
        ? [
            {
              plugins: [
                [_pluginTransformTypescript.default, pluginOptions(isTSX)]
              ]
            }
          ]
        : [
            {
              test: /\.ts$/,
              plugins: [
                [_pluginTransformTypescript.default, pluginOptions(false)]
              ]
            },
            {
              test: /\.tsx$/,
              plugins: [
                [_pluginTransformTypescript.default, pluginOptions(true)]
              ]
            }
          ]
    };
