...
var _corejs3ShippedProposals = _interopRequireDefault(
  require("@babel/compat-data/corejs3-shipped-proposals")
);
...
const corejs3PolyfillsWithShippedProposals = _corejs3ShippedProposals.default.reduce(
  (memo, key) => {
    memo[key] = _data.default[key];
    return memo;
  },
...
function _default(
  ...
  const polyfills = (0, _helperCompilationTargets.filterItems)(
    proposals
      ? _data.default
      : shippedProposals
