...
var _overlappingPlugins = _interopRequireDefault(
  require("@babel/compat-data/overlapping-plugins")
);
...
const pluginLists = {
  ...
  withoutProposals: {
    withoutBugfixes: (0, _utils.filterStageFromList)(
      _pluginsCompatData.plugins,
      _shippedProposals.proposalPlugins
    ),
    withBugfixes: (0, _utils.filterStageFromList)(
      Object.assign(
        {},
        _pluginsCompatData.plugins,
        _pluginsCompatData.pluginsBugfixes
...
var _default = (0, _helperPluginUtils.declare)((api, opts) => {
  ...
  if (
    (optionsTargets == null ? void 0 : optionsTargets.esmodules) &&
  ...
  const modulesPluginNames = getModulesPluginNames({
    ...
    shouldTransformESM:
      modules !== "auto" ||
      !(api.caller == null ? void 0 : api.caller(supportsStaticESM)),
    shouldTransformDynamicImport:
      modules !== "auto" ||
      !(api.caller == null ? void 0 : api.caller(supportsDynamicImport)),
