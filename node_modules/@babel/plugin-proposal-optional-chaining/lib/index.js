...
var _default = (0, _helperPluginUtils.declare)((api, options) => {
  ...
  function isSimpleMemberExpression(expression) {
    ...
    return (
      _core.types.isIdentifier(expression) ||
      _core.types.isSuper(expression) ||
    ...
    visitor: {
      "OptionalCallExpression|OptionalMemberExpression"(path) {
        ...
        const parentPath = path.findParent(p => {
          if (
            !(0,
            _helperSkipTransparentExpressionWrappers.isTransparentExprWrapper)(
              p
            )
          )
            return true;
        ...
        for (let i = optionals.length - 1; i >= 0; i--) {
          ...
          if (
            isCall &&
            _core.types.isIdentifier(chain, {
              name: "eval"
            })
          ) {
            check = ref = chain;
            node[replaceKey] = _core.types.sequenceExpression([
          ...
          if (i === 0 && parentIsCall) {
            ...
            if (!loose || !isSimpleMemberExpression(object)) {
              ...
              if (baseRef) {
                replacement.object = _core.types.assignmentExpression(
                  "=",
                  baseRef,
                  object
                );
            ...
            replacement = _core.types.callExpression(
              _core.types.memberExpression(
                replacement,
                _core.types.identifier("bind")
              ),
              [
                _core.types.cloneNode(
