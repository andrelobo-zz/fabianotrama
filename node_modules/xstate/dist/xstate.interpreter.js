!(function(t, e) {
  ...
  function c(t, e) {
    return "object" == typeof (n = t) &&
      ...
      : h(
          (function(t, e) {
            try {
              return l(t) ? t : t.toString().split(e);
            } catch (e) {
  ...
  function f(t, e, n) {
    ...
    var s = {};
    try {
      for (var a = r(Object.keys(t)), u = a.next(); !u.done; u = a.next()) {
        var c = u.value,
          h = t[c];
        p(h) ? (s[c] = h(e, n.data)) : (s[c] = h);
      }
    } catch (t) {
      i = { error: t };
    } finally {
    ...
    function t(e, r) {
      ...
      void 0 === r && (r = t.defaultOptions),
        ...
        (this.send = function(t, e) {
          if (l(t)) return o.batch(t), o.state;
          var n = S(g(t, e));
    ...
    return (
      ...
      (t.prototype.update = function(t, e) {
        ...
        if (
          ...
          try {
            for (
              var l = r(this.eventListeners), p = l.next();
              !p.done;
              p = l.next()
            ) {
              (0, p.value)(t.event);
        ...
        if (this.state.configuration && x) {
          var b = t.configuration.find(function(t) {
            ...
            g = b && b.doneData ? f(b.doneData, t.context, e) : void 0;
          try {
            for (
      ...
      (t.prototype.stop = function() {
        ...
        try {
          for (var d = r(this.listeners), l = d.next(); !l.done; l = d.next()) {
            var v = l.value;
      ...
      (t.prototype.exec = function(t, n, i) {
        ...
        var r,
          ...
          u = p(a) ? a : a ? a.exec : t.exec;
        if (u)
          try {
            return u(o, s.data, { action: t, state: this.state, _event: s });
          } catch (t) {
            throw (this.parent &&
        ...
        switch (t.type) {
          ...
          case T:
            ...
            if (h.type === e.Invoke) {
              var l = "string" == typeof (r = h.src) ? { type: r } : r,
                v = this.machine.options.services
                  ? this.machine.options.services[l.type]
                  : void 0,
                w = h.id,
                x = h.data,
                b = "autoForward" in h ? h.autoForward : !!h.forward;
              if (!v) return;
              var g = x ? f(x, o, s) : void 0,
                S = p(v) ? v(o, s.data, { data: g, src: l }) : v;
              d(S)
                ? (this.state.children[w] = this.spawnPromise(
                    Promise.resolve(S),
                    w
                  ))
                : p(S)
                ? (this.state.children[w] = this.spawnCallback(S, w))
                : y(S)
                ? (this.state.children[w] = this.spawnObservable(S, w))
                : m(S) &&
                  (this.state.children[w] = this.spawnMachine(
                    g ? S.withContext(g) : S,
                    { id: w, autoForward: b }
                  ));
          ...
          case C:
            var E = t.label,
              _ = t.value;
            E ? this.logger(E, _) : this.logger(_);
        }
      }),
      ...
      (t.prototype.spawn = function(t, e, n) {
        if (d(t)) return this.spawnPromise(Promise.resolve(t), e);
      ...
      (t.prototype.spawnCallback = function(t, e) {
        ...
        if (d(n)) return this.spawnPromise(n, e);
        var a = {
          id: e,
          send: function(t) {
      ...
      return W(void 0, function(e) {
        return e
          ...
          : (function(t, e, n) {
              ...
              return (
                (i.deferred = !0),
                m(t) && (i.state = (n ? t.withContext(n) : t).initialState),
                i
              );
            })(t, n.name);
      });
