!(function(t, e) {
  ...
  function w(t, e, n) {
    ...
    var a = {};
    try {
      for (var s = i(Object.keys(t)), c = s.next(); !c.done; c = s.next()) {
        var u = c.value,
          h = t[u];
        T(h) ? (a[u] = h(e, n.data)) : (a[u] = h);
      }
    } catch (t) {
      r = { error: t };
    } finally {
  ...
  function J(t) {
    var e = [t];
    return U(t) ? e : e.concat(g(z(t).map(J)));
  }
  function B(t, e) {
    var n,
      r,
  ...
  var G = t.ActionTypes.Start,
    ...
    rt = (t.ActionTypes.ErrorExecution, t.ActionTypes.ErrorPlatform),
  ...
  function ft(t, n) {
    ...
    if (N(t) || "number" == typeof t) {
      var r = ht(t, n);
      i = T(r) ? { type: t, exec: r } : r || { type: t, exec: void 0 };
    } else if (T(t)) i = { type: t.name || t.toString(), exec: t };
    else {
      if (T((r = ht(t.type, n)))) i = e(e({}, t), { exec: r });
      else if (r) {
        var o = r.type || t.type;
        i = e(e(e({}, r), t), { type: o });
      } else i = t;
  ...
  function vt(e) {
    return N(e)
      ? { type: Q, event: e }
      : pt(e, { to: t.SpecialTargets.Internal });
  }
  function pt(t, e) {
    return {
      to: e ? e.to : void 0,
  ...
  function yt(n, i) {
    return pt(n, e(e({}, i), { to: t.SpecialTargets.Parent }));
  }
  function gt() {
    return yt(at);
  }
    ...
    return [
      g(
        f.map(function(i) {
          ...
          switch (i.type) {
            case Q:
              return { type: Q, _event: D(i.event) };
            case W:
              return (function(t, n, i, r) {
                var o,
                  a = { _event: i },
                  s = D(T(t.event) ? t.event(n, i.data, a) : t.event);
                if (N(t.delay)) {
                  var c = r && r[t.delay];
                ...
                !(s =
                  null ===
                    (r = i.conds.find(function(e) {
                      ...
                      return !i || R(t, i, l, a, n);
                    })) || void 0 === r
                    ? void 0
                    : r.actions)
              )
                return [];
              var o = Pt(t, n, l, a, lt(x(s), t.options.actions));
              return (l = o[1]), o[0];
            case ct:
              var s;
              if (!(s = i.get(l, a.data))) return [];
              o = Pt(t, n, l, a, lt(x(s), t.options.actions));
              return (l = o[1]), o[0];
            default:
              return ft(i, t.options.actions);
          }
        })
      ),
      l
  ...
  function Vt(t, e, n) {
    ...
    return (
      (i.deferred = !0),
      k(t) && (i.state = (n ? t.withContext(n) : t).initialState),
      i
    );
  }
  function Ct(t) {
  ...
  function It(t) {
    return e(e({ type: it }, t), {
      toJSON: function() {
        t.onDone, t.onError;
        var i = n(t, ["onDone", "onError"]);
        return e(e({}, i), { type: it, src: jt(t.src) });
      }
    });
  }
  var Lt = {},
    ...
    Mt = (function() {
      function a(t, n, r) {
        ...
        !(function t(e) {
          ...
          e.order = u++;
          try {
            for (var o = i(z(e)), a = o.next(); !a.done; a = o.next()) {
              t(a.value);
            }
          } catch (t) {
            n = { error: t };
          ...
          (this.invoke = x(this.config.invoke).map(function(t, n) {
            ...
            if (N(t.src))
              return It(e(e({}, t), { id: t.id || t.src, src: t.src }));
            if (k(t.src) || T(t.src)) {
            ...
            var a = t.src;
            return It(e(e({ id: a.type }, t), { src: a }));
          })),
      ...
      return (
        ...
        (a.prototype.getDelayedTransitions = function() {
          ...
          if (!n) return [];
          var i = function(e, n) {
            var i = _t(T(e) ? t.id + ":delay[" + n + "]" : e, t.id);
            return t.onEntry.push(pt(i, { delay: e })), t.onExit.push(xt(i)), i;
          };
          return (E(n)
            ? n.map(function(t, n) {
                var r = i(t.delay, n);
        ...
        (a.prototype.getStateNodes = function(t) {
          var e,
            n = this;
          if (!t) return [];
          var i = t instanceof At ? t.value : f(t, this.delimiter);
          if (N(i)) {
        ...
        (a.prototype.resolveState = function(t) {
          var n = Array.from(B([], this.getStateNodes(t.value)));
          return new At(
        ...
        (a.prototype.getActions = function(t, e, n, a) {
          var s,
            ...
            u,
            h,
            f = B([], a ? this.getStateNodes(a.value) : [this]),
            l = t.configuration.length ? B(f, t.configuration) : f;
          try {
            for (var d = i(l), v = d.next(); !v.done; v = d.next()) {
              X(f, (m = v.value)) || t.entrySet.push(m);
            }
          } catch (t) {
            s = { error: t };
          } finally {
          ...
          var x = g(
            t.entrySet.map(function(i) {
              ...
              r.push(
                Et(i.id, i.doneData),
                Et(o.id, i.doneData ? w(i.doneData, e, n) : void 0)
              );
              var a = o.parent;
              return (
                "parallel" === a.type &&
                  z(a).every(function(e) {
        ...
        (a.prototype.transition = function(t, e, n) {
          ...
          var i,
            ...
            a = D(e);
          if (t instanceof At)
            i = void 0 === n ? t : this.resolveState(At.from(t, n));
          else {
            var s = N(t)
                ? this.resolve(l(this.getResolvedPath(t)))
                : this.resolve(t),
              c = n || this.machine.context;
            i = this.resolveState(At.from(s, c));
          }
          if (
            this.strict &&
          ...
          var u = this._transition(i.value, i, a) || {
            ...
            h = B([], this.getStateNodes(i.value)),
            f = u.configuration.length ? B(h, u.configuration) : h;
        ...
        (a.prototype.resolveTransition = function(n, o, a, c) {
          var u,
            h,
            f = this;
          void 0 === a && (a = ut), void 0 === c && (c = this.machine.context);
          var l = n.configuration,
            d = !o || n.transitions.length > 0 ? $(this.machine, l) : void 0,
            v = o
              ? o.historyValue
                ? o.historyValue
                : n.source
              ...
              : void 0,
            p = o ? o.context : c,
            y = this.getActions(n, p, a, o),
            g = o ? e({}, o.activities) : {};
          try {
            for (var m = i(y), x = m.next(); !x.done; x = m.next()) {
              var S = x.value;
              S.type === G
                ? (g[S.activity.id || S.activity.type] = S)
                : S.type === K && (g[S.activity.id || S.activity.type] = !1);
            }
          } catch (t) {
            u = { error: t };
          } finally {
          ...
          var E,
            ...
            k = r(
              b(P, function(e) {
                return (
                  e.type === Q ||
                  (e.type === W && e.to === t.SpecialTargets.Internal)
                );
              }),
              2
            ),
            ...
            j = P.filter(function(t) {
              return t.type === G && t.activity.type === it;
            }).reduce(
              function(t, e) {
                return (
                  (t[e.activity.id] = (function(t, e, n, i) {
                    var r,
                      ...
                      a =
                        null ===
                          (r = null == e ? void 0 : e.options.services) ||
                        void 0 === r
                          ? void 0
                          : r[o.type],
                      s = t.data ? w(t.data, n, i) : void 0,
                      c = a ? Vt(a, t.id, s) : kt(t.id);
                    return (c.meta = t), c;
                  })(e.activity, f.machine, A, a)),
                  t
                );
              },
              o ? e({}, o.children) : {}
            ),
            I = d ? n.configuration : o ? o.configuration : [],
            ...
            M = new At({
              ...
              historyValue: d
                ? v
                  ? ((E = v), (T = d), { current: T, states: _(E, T) })
                  : void 0
                : o
                ? o.historyValue
                : void 0,
              history: !d || n.source ? o : void 0,
              actions: d ? C : [],
              activities: d ? g : o ? o.activities : {},
              meta: d ? L : o ? o.meta : void 0,
              events: [],
              configuration: I,
            ...
            R = p !== A;
          M.changed = a.name === at || R;
          var U = M.history;
          if ((U && delete U.history, !d)) return M;
          var z = M;
          if (!D)
            for (
              (this._transient ||
              ...
              (z = this.resolveRaisedTransition(z, { type: Z }, a));
              V.length;

            ) {
              var J = V.shift();
              z = this.resolveRaisedTransition(z, J._event, a);
            }
          var B =
            z.changed ||
            (U
          ...
          return (
            (z.changed = B),
            (z.historyValue = M.historyValue),
            (z.history = U),
            z
          );
        }),
        (a.prototype.getStateNode = function(t) {
          if (Dt(t)) return this.machine.getStateNodeById(t);
          if (!this.states)
            throw new Error(
        ...
        (a.prototype.resolve = function(t) {
          var e,
            n = this;
          if (!t) return this.initialStateValue || Lt;
          switch (this.type) {
            case "parallel":
              return d(this.initialStateValue, function(e, i) {
                return e ? n.getStateNode(i).resolve(t[i] || e) : Lt;
              });
            case "compound":
              if (N(t)) {
              ...
              return s(t).length
                ? d(t, function(t, e) {
                    return t ? n.getStateNode(e).resolve(t) : Lt;
                  })
        ...
        (a.prototype.formatTransitions = function() {
          ...
          var l = this.config.always ? M("", this.config.always) : [],
            d = this.config.onDone
              ? M(String(Et(this.id)), this.config.onDone)
              : [],
            v = g(
              this.invoke.map(function(t) {
                var e = [];
                return (
                  t.onDone && e.push.apply(e, o(M(String(Tt(t.id)), t.onDone))),
                  t.onError &&
                    e.push.apply(e, o(M(String(Nt(t.id)), t.onError))),
                  e
                );
              })
            ),
          ...
          try {
            for (var m = i(p), w = m.next(); !w.done; w = m.next()) {
              var S = w.value;
              y.push(S);
            }
          } catch (e) {
  ...
  var Rt,
    ...
    Gt = { sync: !1, autoForward: !1 },
    Kt =
      ((Rt = []),
      function(t, e) {
        t && Rt.push(t);
        var n = e(t || Rt[Rt.length - 1]);
        return t && Rt.pop(), n;
      });
  !(function(t) {
    ...
    function n(i, r) {
      ...
      void 0 === r && (r = n.defaultOptions),
        ...
        (this.send = function(t, e) {
          ...
          var n = D(L(t, e));
          if (o._status === Ft.Stopped) return o.state;
          if (o._status === Ft.NotStarted && o.options.deferEvents);
          else if (o._status !== Ft.Running)
            throw new Error(
              'Event "' +
                n.name +
        ...
        (this.sendTo = function(n, i) {
          var r =
            ...
            a = r ? o.parent : Ct(i) ? i : o.children.get(i) || Xt(i);
          if (a)
            "machine" in a
              ? a.send(
                  e(e({}, n), {
                    name: n.name === ot ? "" + Nt(o.id) : n.name,
                    origin: o.sessionId
                  })
                )
              : a.send(n.data);
      ...
      (this.id = f),
        ...
        (this.parent = u),
        (this.options = a),
        (this.scheduler = new zt({ deferEvents: this.options.deferEvents })),
        (this.sessionId = qt());
    }
    return (
      ...
      (n.prototype.update = function(t, e) {
        ...
        if (this.state.configuration && m) {
          var x = t.configuration.find(function(t) {
            ...
            S = x && x.doneData ? w(x.doneData, t.context, e) : void 0;
          try {
            for (
      ...
      (n.prototype.onTransition = function(t) {
        return (
          ...
          this._status === Ft.Running && t(this.state, this.state.event),
          this
        );
      }),
      (n.prototype.subscribe = function(t, e, n) {
        ...
        return (
          ...
          this._status === Ft.Running && i(this.state),
          o && this.onDone(o),
          {
      ...
      (n.prototype.start = function(t) {
        var e = this;
        if (this._status === Ft.Running) return this;
        $t(this.sessionId, this),
          (this.initialized = !0),
          (this._status = Ft.Running);
        var n =
          void 0 === t
            ? this.initialState
            : Kt(this, function() {
                return !N((n = t)) && "value" in n && "history" in n
                  ...
                  : e.machine.resolveState(At.from(t, e.machine.context));
                var n;
              });
        return (
      ...
      (n.prototype.stop = function() {
        ...
        try {
          for (
            var x = i(this.doneListeners), w = x.next();
            !w.done;
            w = x.next()
          ) {
            v = w.value;
        ...
        try {
          for (
            var S = i(s(this.delayedEventsMap)), b = S.next();
            !b.done;
            b = S.next()
          ) {
            var _ = b.value;
      ...
      (n.prototype.batch = function(t) {
        var n = this;
        if (this._status === Ft.NotStarted && this.options.deferEvents);
        else if (this._status !== Ft.Running)
          throw new Error(
            t.length +
        ...
        this.scheduler.schedule(function() {
          ...
          (s.changed = c), (s.actions = u), n.update(s, D(t[t.length - 1]));
        });
      }),
          ...
          case G:
            ...
            if (u.type === t.ActionTypes.Invoke) {
              var h = F(u.src),
                ...
                l = u.id,
                d = u.data,
                v = "autoForward" in u ? u.autoForward : !!u.forward;
              if (!f) return;
              var p = d ? w(d, r, o) : void 0,
                y = T(f) ? f(r, o.data, { data: p, src: h }) : f;
              S(y)
                ? (this.state.children[l] = this.spawnPromise(
                    Promise.resolve(y),
                    l
                  ))
                : T(y)
                ? (this.state.children[l] = this.spawnCallback(y, l))
                : P(y)
                ? (this.state.children[l] = this.spawnObservable(y, l))
                : k(y) &&
                  (this.state.children[l] = this.spawnMachine(
                    p ? y.withContext(p) : y,
                    { id: l, autoForward: v }
                  ));
      ...
      (n.prototype.spawn = function(t, n, i) {
        if (S(t)) return this.spawnPromise(Promise.resolve(t), n);
        if (T(t)) return this.spawnCallback(t, n);
        if (Ct(t)) return this.spawnActor(t);
      ...
      (n.prototype.spawnMachine = function(t, i) {
        ...
        return (
          ...
          o
            .onDone(function(t) {
              r.removeChild(o.id), r.send(D(t, { origin: o.id }));
            })
            .start(),
          s
        );
      ...
      (n.prototype.spawnPromise = function(t, e) {
        ...
        t.then(
          function(t) {
            i || (n.removeChild(e), n.send(D(Tt(e, t), { origin: e })));
          },
          function(t) {
            if (!i) {
              n.removeChild(e);
      ...
      (n.prototype.spawnCallback = function(t, e) {
        ...
        if (S(n)) return this.spawnPromise(n, e);
        var s = {
          id: e,
          send: function(t) {
      ...
      (n.prototype.spawnObservable = function(t, e) {
        var n = this,
          i = t.subscribe(
            ...
            function(t) {
              n.removeChild(e), n.send(D(Nt(e, t), { origin: e }));
            },
            function() {
              n.removeChild(e), n.send(D(Tt(e), { origin: e }));
            }
          ),
          r = {
            id: e,
  ...
  var Yt = {
    ...
    escalate: function(n, i) {
      return yt(function(t, e, i) {
        return { type: ot, data: T(n) ? n(t, e, i) : n };
  ...
  (t.Interpreter = Qt),
    ...
    (t.matchState = function(t, e, n) {
      var o,
        a,
        s = At.from(t, t instanceof At ? t.context : void 0);
      try {
    ...
    (t.spawn = function(t, n) {
      ...
      return Kt(void 0, function(e) {
        return e ? e.spawn(t, i.name, i) : Vt(t, i.name);
      });
    }),
