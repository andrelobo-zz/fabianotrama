!(function(e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : t(((e = e || self).emotionCore = {}), e.React);
})(this, function(e, t) {
  "use strict";
  var r = function(e, t) {
  ...
  function n(e) {
    ...
    function o(e, r) {
      ...
      var h = (function e(r, c, o, h, f) {
        for (
          ...
          if (
            ...
            if (
              P === L &&
              (0 < I && (q = q.replace(u, "")), 0 < q.trim().length)
            ) {
              switch (p) {
                case 32:
                case 9:
            ...
            switch (p) {
              case 123:
                for (
                  d = (q = q.trim()).charCodeAt(0), m = 1, D = ++P;
                  P < W;
                ...
                switch (
                  ...
                  case 64:
                    switch (
                      (0 < I && (q = q.replace(u, "")), (p = q.charCodeAt(1)))
                    ) {
                      case 100:
                      case 109:
                      case 115:
                    ...
                    if (
                      ((D = (m = e(c, I, m, p, f + 1)).length),
                      0 < j &&
                        ((w = i(3, m, (I = t(N, q, T)), c, _, O, D, p, f, h)),
                        (q = I.join("")),
                        void 0 !== w &&
                          0 === (D = (m = w.trim()).length) &&
                          ((p = 0), (m = ""))),
              ...
              case 59:
                if (
                  1 < (D = (q = (0 < I ? q.replace(u, "") : q).trim()).length)
                )
                  switch (
                    (0 === G &&
                      ((d = q.charCodeAt(0)),
                    ...
                    0 < j &&
                      void 0 !== (w = i(1, q, c, r, _, O, U.length, h, f, h)) &&
                      0 === (D = (q = w.trim()).length) &&
                      (q = "\0\0"),
                    (d = q.charCodeAt(0)),
                    (p = q.charCodeAt(1)),
            ...
            case 10:
              47 === A
                ...
                : 0 === 1 + d &&
                  ...
                  0 < q.length &&
                  ((I = 1), (q += "\0")),
                0 < j * M && i(0, q, c, r, _, O, U.length, h, f, h),
                (O = 1),
                _++;
              break;
            case 59:
        ...
        if (0 < (D = U.length)) {
          if (
            ((I = c),
            0 < j &&
              void 0 !== (w = i(2, U, I, r, _, O, D, h, f, h)) &&
              0 === (U = w).length)
          )
            return H + U + F;
          if (((U = I.join(",") + "{" + U + "}"), 0 != z * S)) {
      ...
      return (
        0 < j &&
          void 0 !== (o = i(-2, h, c, c, _, O, h.length, 0, 0, 0)) && (h = o),
        "",
        (S = 0),
        (O = _ = 1),
        h
  ...
  var p,
    ...
    w = function(e, t) {
      ...
      return 1 === d[e] || g(e) || "number" != typeof t || 0 === t
        ? t
        : t + "px";
    };
  function C(e, t, r, a) {
    ...
    switch (typeof r) {
      ...
      case "object":
        ...
        if (void 0 !== r.styles) {
          ...
          if (void 0 !== n)
            for (; void 0 !== n; )
              (A = { name: n.name, styles: n.styles, next: A }), (n = n.next);
          return r.styles + ";";
        }
  ...
  var A,
    ...
    S = function(e, r, a, n) {
      ...
      "string" == typeof r.className
        ? (o = h(e.registered, c, r.className))
    ...
    z = e.withEmotionCache(function(e, r, a) {
      return "function" == typeof e.css
        ? t.createElement(l.Consumer, null, function(t) {
            return S(r, e, t, a);
          })
        : S(r, e, null, a);
    }),
    N = e.withEmotionCache(function(e, r) {
      ...
      if ("function" == typeof a)
        return t.createElement(l.Consumer, null, function(e) {
          var n = E([a(e)]);
          return t.createElement($, { serialized: n, cache: r });
        });
      var n = E([a]);
      return t.createElement($, { serialized: n, cache: r });
    }),
