...
var _inheritsLoose = _interopDefault(
  ...
  EmotionCacheContext = React.createContext(
    "undefined" != typeof HTMLElement ? createCache() : null
  ),
...
var typePropName = "__EMOTION_TYPE_PLEASE_DO_NOT_USE__",
  ...
  jsx = function(type, props) {
    var args = arguments;
    if (null == props || !hasOwnProperty.call(props, "css"))
        ...
        if (!isBrowser) {
          for (
            ...
            (serializedNames += " " + next.name),
              ...
              (next = next.next);
          var _ref,
            shouldCache = !0 === this.props.cache.compat,
            rules = this.props.cache.insert(
              "",
              {
